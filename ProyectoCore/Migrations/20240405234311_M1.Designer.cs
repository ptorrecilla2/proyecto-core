            ...
            modelBuilder.Entity("ProyectoCore.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 4, 6, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2507),
                        ...
                        {
                            Id = 2,
                            Date = new DateTime(2024, 4, 6, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2510),
            ...
            modelBuilder.Entity("ProyectoCore.Models.ProjectTask", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            FinalDate = new DateTime(2024, 4, 13, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2471),
                            InitialDate = new DateTime(2024, 4, 6, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2421),
                            Name = "Task1",
                            Priority = 2,
                            ProjectId = 1,
                            Status = 0
                        ...
                        {
                            Id = 2,
                            FinalDate = new DateTime(2024, 4, 11, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2480),
                            InitialDate = new DateTime(2024, 4, 6, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2478),
                            Name = "Task2",
                            Priority = 1,
                            ProjectId = 2,
                            Status = 1
                        ...
                        {
                            Id = 3,
                            FinalDate = new DateTime(2024, 4, 9, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2484),
                            InitialDate = new DateTime(2024, 4, 6, 1, 43, 9, 667, DateTimeKind.Local).AddTicks(2482),
                            Name = "Task3",
                            Priority = 0,
                            ProjectId = 3,
                            Status = 2
